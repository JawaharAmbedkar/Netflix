...
export default function SignIn() {
  ...
  return (
    <AuthPageShell
      title="Sign in"
      subtitle="Continue to your premium streaming experience."
      label="Account"
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        {error ? <div className="rounded-2xl border border-red-500/20 bg-red-950/40 px-4 py-3 text-sm text-red-200">{error}</div> : null}
      ...
      >
        ...
        <span className="text-sm font-medium text-warm-100">Sign in with Google</span>
      </button>
